...
const ReactQuill = dynamic(() => import("react-quill-new"), { src: false });
...
const PostEditorContent = ({ form, setQuillRef, onImageUpload }) => {
  ...
  const handleAI = async (type, improvementType = null) => {
    ...
    if (type === "generate") {
      if (!title?.trim())
        return toast.error("Please add a little before generating content");
        ...
        <div className="space-y-5">
          ...
          <div className="">
            <Input
              ...
              className="border-0 text-4xl font-bold bg-transparent placeholder:text-slate-500 text-white p-0 h-auto focus-visible:right-0 focus-visible:ring-offset-0"
